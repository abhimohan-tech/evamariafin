...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, IMDB, \
    SPELL_CHECK_REPLY, IMDB_TEMPLATE, IMDB_DELET_TIME, START_MESSAGE
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🎬 Updates', url='https://t.me/FF_OTT_Updates2'),
            InlineKeyboardButton("💖 Share", url="https://t.me/share/url?url=Join%20%40FFMoviesBot%20For%20Download%20New%20Movies")   
        ], [
            InlineKeyboardButton('🏠 Home', callback_data='start'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="💢 ᴊᴏɪɴ ᴏᴜʀ ɢʀᴏᴜᴘ 💢",url="https://t.me/aml_official")]
        )
    else:
        btn.append(
